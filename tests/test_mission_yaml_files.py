...
class TestMakeSummaryYaml:
    ...
    def test_make_summary_yaml_basic(self, mock_input, temp_dir):
    ...
    def test_make_summary_yaml_with_repeats(self, mock_input, temp_dir):
    ...
    def test_make_summary_yaml_no_overwrite(self, mock_input, temp_dir):
    ...
    def test_make_summary_yaml_overwrite(self, mock_input, temp_dir):
    ...
    def test_make_summary_yaml_invalid_input(self, mock_input, temp_dir):
    ...
    def test_make_summary_yaml_invalid_number(self, mock_input, temp_dir):
...
class TestMakeFailureYaml:
    ...
    @patch("builtins.input", side_effect=["n", ""])
    def test_make_failure_yaml_no_failure(self, mock_input, temp_dir):
    ...
    @patch(
        "builtins.input",
        side_effect=["y", "1", "Mechanical issue", "0", "0", "General notes"],
    )
    def test_make_failure_yaml_with_mechanical(self, mock_input, temp_dir):
    ...
    def test_make_failure_yaml_multiple_failures(self, mock_input, temp_dir):
    ...
    @patch("builtins.input", side_effect=["n"])
    def test_make_failure_yaml_no_overwrite(self, mock_input, temp_dir):
    ...
    def test_make_failure_yaml_invalid_yn_input(self, mock_input, temp_dir):
    ...
    def test_make_failure_yaml_invalid_category_input(self, mock_input, temp_dir):
...
class TestYamlFileStructure:
    ...
    @patch("builtins.input", side_effect=["y", "n", "n", ""])
    def test_summary_yaml_is_valid_yaml(self, mock_input, temp_dir):
    ...
    def test_failure_yaml_is_valid_yaml(self, mock_input, temp_dir):
    ...
    def test_summary_yaml_preserves_user_notes(self, mock_input, temp_dir):
    ...
    @patch(
        "builtins.input",
        side_effect=["y", "1", "Issue description", "0", "0", "Additional notes"],
    )
    def test_failure_yaml_preserves_comments(self, mock_input, temp_dir):
...
def test_summary_yaml_various_inputs(temp_dir, frf, overlap, repeat, count):
