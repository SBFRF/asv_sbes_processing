...
**Current Coverage: 18.5%** with 46 passing tests. Many tests (79 total) are currently disabled because they require sample data files.

For a comprehensive guide on improving coverage from 18% → 80%, including:
- Step-by-step instructions for adding sample data
- Data anonymization examples
- Directory structure and file requirements
- How to enable disabled tests

**See [TESTING.md](../TESTING.md#how-to-improve-test-coverage)** for the complete coverage improvement guide.
